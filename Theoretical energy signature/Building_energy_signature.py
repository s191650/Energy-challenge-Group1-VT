...
meteo = pd.read_table('Theoretical energy signature/Meteo.csv',delimiter =";")
bg = pd.read_table('Theoretical energy signature/Building_geometry.csv',delimiter =";")
...
for j in range(size_col):
    ...
    plt.savefig(f"Theoretical energy signature/Energy-signature/{str(bg.index[j])}.png")
    plt.clf()
    ...
    plt.savefig(f"Theoretical energy signature/Load-curve/{str(bg.index[j])}-load-curve.png")
    plt.clf()
